...
static status_t vmi_read_sw_trap(vmi_instance_t vmi, addr_t pa, uint32_t* value)
{
...
static status_t vmi_write_sw_trap(vmi_instance_t vmi, addr_t pa, uint32_t* value)
{
#if defined(I386) || defined(X86_64)
